...
AI_ASSISTANT_PROMPT = """Είσαι η «Sophia», ο ψηφιακός βοηθός της πλατφόρμας Εστία (CONDIAN HOTELS — όμιλος 5 ξενοδοχείων).
Βοηθάς το προσωπικό και τη διοίκηση στην καθημερινή λειτουργία, οργάνωση, συντήρηση και τεχνικά θέματα.
# ΒΑΣΙΚΕΣ ΑΡΧΕΣ
- Απαντάς στα ελληνικά, σύντομα και πρακτικά — «τι να κάνω τώρα», όχι θεωρία.
- Βασίζεσαι ΜΟΝΟ στα δεδομένα που σου δίνονται και στην εμβέλεια (ρόλο & ξενοδοχεία) του χρήστη. Αν δεν έχεις στοιχείο, το λες καθαρά — δεν εικάζεις.
- ΠΟΤΕ δεν αποκαλύπτεις δεδομένα εκτός των δικαιωμάτων ή των ξενοδοχείων που βλέπει ο χρήστης.
- Σε επείγοντα (ασφάλεια, σοβαρή βλάβη, ατύχημα) δίνεις άμεση οδηγία ασφαλείας και σύσταση ειδοποίησης υπευθύνου.
# ΤΟΜΕΙΣ ΠΟΥ ΜΠΟΡΕΙΣ ΝΑ ΒΟΗΘΗΣΕΙΣ
- Λειτουργίες & οργάνωση: προγράμματα/βάρδιες, εργασίες, οργάνωση προσωπικού, καθημερινές διαδικασίες.
- Συντήρηση & τεχνικά: βλάβες, μετρήσεις, όρια → ενέργειες, δίκτυα νερού/ΖΝΧ (legionella), εξοπλισμός.
- Χημεία νερού πισίνας (όταν δίνονται μετρήσεις): ερμηνεία pH/χλωρίου/αλκαλικότητας/κυανουρικού κ.λπ. + δοσολογία με βάση τον όγκο. ΠΟΤΕ μην προτείνεις ανάμειξη χλωρίου με οξέα ή χημικών μεταξύ τους.
# ΥΦΟΣ
- Απλή γλώσσα, σαφή βήματα, checklists όπου βοηθά.
- Δεν αντικαθιστάς πιστοποιημένο τεχνικό ή τη νομοθεσία· σε τιμές/όρια σύστησε επαλήθευση με τους τοπικούς κανονισμούς.
- Όπου ταιριάζει, πρότεινε τι να καταγραφεί στο log."""
...
CHANGELOG = [
    {'v': '12.453', 'b': '741', 'date': '11/07/2026', 'time': '11:30', 'title': 'Business Μισθοδοσία — λογική ροή καρτέλας: σταθερή κεφαλίδα · χρήση πάνω από tabs (χωρίς refresh) · σύνολα έτους',
     'items': ['Αναδιάταξη για καθαρή ανάγνωση: **σταθερή κεφαλίδα** πάντα ορατή (όνομα · ΑΦΜ · ΑΜΚΑ · ΑΜ ΙΚΑ · κωδικός · ειδικότητα · **email & IBAN** — αυτο-εντοπίζονται από τα δεδομένα). **Χρήση πάνω από τα tabs**, με προεπιλογή την τελευταία· η αλλαγή χρήσης γίνεται **χωρίς refresh σελίδας** (φιλτράρει άμεσα).',
               '**2 tabs:** «Ανάλυση χρήσης» = κάρτες με **σύνολα έτους** (Σ Μικτές/Καθαρό/Κόστος/Περίοδοι) + μήνες κατηγοριοποιημένοι αριστερά + ανάλυση επιλεγμένου μήνα δεξιά (Βασικά/Όλα + στήλη «πού πάει»). «Όλες οι εγγραφές» = επίπεδη λίστα όλων των περιόδων (όλες οι χρήσεις) όπου φαίνονται αλλαγές εταιρείας/υποκαταστήματος στον χρόνο.']},
    {'v': '12.453', 'b': '740', 'date': '10/07/2026', 'time': '16:15', 'title': 'Business Μισθοδοσία — καρτέλα εργαζομένου ως hub (περίοδοι μέσα · tabs Περίοδοι/Ταυτότητα/Data)',
     'items': ['Ανοίγοντας εργαζόμενο βλέπεις πλέον **μία οθόνη-hub** αντί για ενδιάμεση λίστα: **αριστερά οι περίοδοι κατηγοριοποιημένες** (Μηνιαίες / Δώρα-Επιδόματα / Εκκαθαρίσεις-Αναδρομικά / Λοιπά, ανά χρήση), **δεξιά** η οθόνη πεδίων της επιλεγμένης περιόδου (σύνοψη + Βασικά/Όλα + στήλη «πού πάει στην Εστία»).',
               '**Tabs:** «Περίοδοι» · «Ταυτότητα &amp; στοιχεία» (τα σταθερά στοιχεία του εργαζομένου) · **«Data»** = ΟΛΑ τα πεδία που τραβάμε, verbatim, **μαζί με τα μηδενικά και τα κενά**, με την αντιστοίχιση προς τα πεδία της Εστίας — χωρίς φίλτρα.']},
    {'v': '12.453', 'b': '739', 'date': '10/07/2026', 'time': '15:30', 'title': 'Business Μισθοδοσία — οθόνη περιόδου: σύνοψη ποσών, «Βασικά/Όλα», στήλη «πού πάει στην Εστία»',
     'items': ['Η οθόνη μιας περιόδου αναδιαμορφώθηκε για **εύκολη ανάγνωση**: μικρή **σύνοψη ποσών-κλειδιών** πάνω (Μικτές·Πρόσθετες·ΕΦΚΑ·ΦΜΥ·Πληρωτέο·Κόστος) · διακόπτης **«Βασικά / Όλα τα πεδία»** · **«κρύψε κενά»** (κρύβει μόνο τα άδεια — τα μηδενικά μένουν, γιατί το 0 είναι πληροφορία).',
               '**Νέα στήλη «→ πού πάει στην Εστία»** ανά πεδίο: δείχνει σε ποιο σημείο της Εστίας καταλήγει (π.χ. `M_APODOXES → Μισθοδοσία › Μικτές`) ή **«● διαθέσιμο»** αν δεν το χρησιμοποιούμε ακόμα. Ο χάρτης ξεκινά από ό,τι ήδη γράφει το curated και μεγαλώνει σιγά-σιγά. Read-only.']},
    {'v': '12.453', 'b': '736', 'date': '10/07/2026', 'time': '14:10', 'title': 'Business Μισθοδοσία — οθόνη επιθεώρησης σύνδεσης Epsilon (το πρώτο σημείο ελέγχου)',
     'items': ['Νέα οθόνη **«Business Μισθοδοσία (Epsilon)»** στο μενού Μισθοδοσίας (workspace **Admin**): read-only επιθεώρηση **τι φέρνει ολόκληρη** η σύνδεση από την Epsilon, πριν μπει στα κυκλώματα της Εστίας — χωρίς κατέβασμα Excel. Πάνω-πάνω «κατάσταση σύνδεσης» (γραμμές, εργαζόμενοι, τελ. συγχρονισμός, ✓ λειτουργεί).',
               'Καταχωρήθηκε στον κατάλογο μενού (`menu.py`). Σε custom μενού εμφανίζεται αυτόματα στην ομάδα **«🆕 Νέα»** (Admin) — σύρε το στη «Μισθοδοσία» από τη Διαμόρφωση μενού αν το θες μόνιμα εκεί.',
               'Βελτιώσεις οθόνης: **full-width**, φίλτρα (χρήση/αναζήτηση) μέσα στο πάνω πλαίσιο, **κωδικός πριν το ονοματεπώνυμο**, **ζωντανή αναζήτηση**, ωμό όνομα πεδίου Epsilon γκρι μπροστά από την ετικέτα.',
               '**Καθαρή εικόνα ανά περίοδο:** αφαιρέθηκαν οι «διπλοί μήνες» (artifact re-ingestion του bronze — κρατείται η πιο πρόσφατη· το curated ήταν ήδη σωστό). **Δοκιμαστικές εγγραφές** (χρήση 0· το λογιστήριο δεν τις βλέπει στη μισθοδοσία) **δεν εμφανίζονται** πλέον — κρατούνται παρκαρισμένες στο bronze & προσβάσιμες με ένα κλικ («🧪 Δοκιμαστικές εγγραφές»).',
               'Αναζήτηση εργαζομένου (επώνυμο/όνομα/ΑΦΜ/κωδικός) → περίοδοι → **όλα τα πεδία** της περιόδου, με ελληνικές ετικέτες + το ωμό όνομα πεδίου Epsilon + «Λοιπά πεδία» (ό,τι δεν έχει ακόμη ετικέτα). Διαβάζει μόνο το bronze landing (verbatim). Οι στήλες «πού πάει στην Εστία» θα προστεθούν σιγά-σιγά.']},
    {'v': '12.452', 'b': '733', 'date': '09/07/2026', 'time': '23:20', 'title': 'Data Hub — bulletproof landing (επεξεργασία γραμμή-γραμμή· καμία «κακή» γραμμή δεν ρίχνει το batch)',
     'items': ['Το endpoint υποδοχής επεξεργάζεται πλέον **κάθε γραμμή ξεχωριστά** (savepoint): αν μία γραμμή έχει προβληματικό δεδομένο, **προσπερνιέται και καταγράφεται**, ενώ όλες οι υπόλοιπες αποθηκεύονται κανονικά. Τέλος τα «σκάσιμο ολόκληρου batch» (HTTP 500).',
               'Τα ωμά δεδομένα (bronze) κρατιούνται **πάντα**, ακόμη κι αν αποτύχει ο υπολογισμός του curated για μια γραμμή (ξεχωριστά savepoints — «τίποτα δεν χάνεται»). Το `/verify` δείχνει τώρα και τα τελευταία μηνύματα λάθους, για διάγνωση.']},
    {'v': '12.451', 'b': '732', 'date': '09/07/2026', 'time': '21:45', 'title': 'Data Hub — ανθεκτικό landing (κόψιμο πεδίων στο σωστό μήκος + καθαρισμός κακών χαρακτήρων)',
     'items': ['Ο on-prem agent τραβάει πλέον **όλα τα πεδία** της Epsilon (639 μισθοδοσίας + 671 μητρώου). Κάποια κείμενα ήταν μεγαλύτερα απ\' όσο χωρούσαν οι στήλες → η εισαγωγή «έσκαγε» (HTTP 500) σε 1 batch. Πλέον το endpoint **κόβει κάθε πεδίο στο ακριβές μήκος της στήλης** του και **καθαρίζει μη-έγκυρους χαρακτήρες** (null bytes) — δεν σκάει ποτέ.',
               'Τίποτα δεν χάνεται: το πλήρες κείμενο διατηρείται ολόκληρο στο `raw_json` (bronze). Ο agent έγινε επίσης **ανθεκτικός**: αν ένα batch αποτύχει, το προσπερνά και συνεχίζει (δεν σταματά όλη η νυχτερινή δουλειά).']},
    ...
    {'v': '12.448', 'b': '729', 'date': '09/07/2026', 'time': '15:20', 'title': 'Data Hub Φ2 «prove-the-pipe» — άθροισμα εκκαθαριστικού όταν εργαζόμενος έχει >1 θητεία/μήνα',
     'items': ['Υποδομή (χωρίς UI): εργαλείο `tools/datahub_seed.py` που στέλνει τα ήδη επικυρωμένα δεδομένα (2024: 1.689 γραμμές, 154 εργαζόμενοι) στο endpoint και βγάζει reconciliation — απόδειξη ότι ο σωλήνας υποδοχής δουλεύει, χωρίς τον on-prem agent.',
               '**Διόρθωση (P-097):** όταν η Epsilon σπάει το εκκαθαριστικό ενός εργαζομένου σε πολλές γραμμές τον ίδιο μήνα (π.χ. 2 θητείες/επεισόδια), ο συνοπτικός πίνακας (που διαβάζει η μισθοδοσία) πλέον **αθροίζει** τις γραμμές — ακριβώς όπως το εκκαθαριστικό του λογιστηρίου — αντί να κρατά μόνο τη μία.',
               'Επίδραση στα δεδομένα δοκιμής: το σύνολο αποδοχών 2024 διορθώθηκε από 1.235.472 σε **1.295.609** (πλήρης συμφωνία στο σεντ με την πηγή). Το άθροισμα είναι idempotent (ξαναϋπολογίζεται από τα ωμά δεδομένα — τα re-runs δεν διπλομετρούν).']},
    ...
    {'v': '12.446', 'b': '727', 'date': '08/07/2026', 'time': '18:10', 'title': 'Piato — Επεξεργασία πιάτου/κατηγορίας σε pop-up (μολύβι) αντί για dropdown',
     'items': ['Κάθε **πιάτο** έχει τώρα εικονίδιο **μολυβιού αριστερά από το όνομα** → ανοίγει **παράθυρο (pop-up)** επεξεργασίας. Έφυγε εντελώς το dropdown «Επεξεργασία πιάτου» από κάτω.',
               ...
               'Το «άνοιγμα/σύμπτυξη» κατηγορίας → πιάτα **παραμένει** ως έχει. Το pop-up κλείνει με το X, κλικ έξω ή ESC.']},
    {'v': '12.445', 'b': '726', 'date': '08/07/2026', 'time': '16:30', 'title': 'Piato — Εισαγωγή μενού από αρχείο με AI (φωτο/PDF/Word/Excel) + αυτόματες μεταφράσεις',
     'items': ['Νέο κουμπί **«Εισαγωγή μενού»** στην καρτέλα Μενού: ανεβάζεις **φωτογραφία, PDF, Word ή Excel** ενός υπάρχοντος μενού.',
               'Το AI διαβάζει **κατηγορίες · πιάτα · περιγραφές · τιμές · αλλεργιογόνα** και τα **μεταφράζει αυτόματα σε όλες τις γλώσσες** (EL/EN/DE/IT/FR) — με μία κίνηση.',
               'Ανοίγει **πίνακας ελέγχου** (γραμμές & στήλες) με **εναλλαγή γλώσσας**: διορθώνεις ό,τι θες (τίτλους, περιγραφές, τιμές, αλλεργιογόνα) → **«Καταχώρηση»** → μπαίνουν στο επιλεγμένο μενού. Μετά, κανονικό edit όπως πάντα.',
               'Πρόσβαση μόνο σε manager/admin· περνά από την πύλη διακυβέρνησης (κελί «Piato · Εισαγωγή μενού» στην Κονσόλα AI).']},
    {'v': '12.444', 'b': '725', 'date': '08/07/2026', 'time': '15:00', 'title': 'Piato — απόσυρση πρόχειρης «Εισαγωγής AI» (επανασχεδιάστηκε με προδιαγραφή)',
     'items': ['Αφαιρέθηκε η πρόχειρη καρτέλα «Εισαγωγή AI» και επανασχεδιάστηκε σωστά (βλ. v12.445).']},
    ...
    {'v': '12.441', 'b': '722', 'date': '08/07/2026', 'time': '12:40', 'title': 'Piato — Πολλαπλά ονομαστά μενού ανά σημείο (multi-menu) + σύρσιμο μεταξύ μενού',
     'items': ['Κάθε σημείο μπορεί πλέον να έχει **πολλά ονομαστά μενού** (π.χ. Φαγητό · Ποτά · Cocktails · Πρωινό). Τα υπάρχοντα food/drink **μεταφέρθηκαν αυτόματα** σε δύο μενού «Φαγητό»/«Ποτά» — μηδενική απώλεια, ο πελάτης βλέπει τα ίδια.',
               'Στον builder κάθε μενού είναι **ενότητα** με τις κατηγορίες του: **σέρνεις κατηγορία από μενού σε μενού**, σέρνεις μενού για αναδιάταξη, και δημιουργείς/μετονομάζεις/σβήνεις μενού (με εικονίδιο). Οι μετρητές ενημερώνονται ζωντανά.',
               'Μη-καταστροφικό σχήμα: νέος πίνακας `piato_menu` + στήλη `piato_category.menu_id` (idempotent migration). Νέα endpoints menu/save·delete·reorder + category/reorder με μενού-στόχο (όλα hotel-scoped).',
               '(Το μενού του πελάτη θα ομαδοποιηθεί ανά μενού με tabs στο επόμενο βήμα.)']},
    {'v': '12.440', 'b': '721', 'date': '08/07/2026', 'time': '11:30', 'title': 'Piato — Drag & drop στο διαχειριστικό μενού + καθάρισμα καρτέλας Μενού',
     'items': ['**Σύρε & άφησε** στο μενού: πιάνεις τη λαβή ⋮⋮ και **σέρνεις κατηγορίες** για αναδιάταξη ή **πιάτα** — αναδιάταξη μέσα στην κατηγορία **ή μετακίνηση σε άλλη κατηγορία**. Αντικατέστησε τα βελάκια ↑↓.',
               'Οι μετρητές πιάτων ανά κατηγορία ενημερώνονται **ζωντανά** καθώς σέρνεις. (SortableJS, client-side — μηδέν εξάρτηση server.)',
               'Καθαρίστηκε η καρτέλα **Μενού**: ο δημόσιος σύνδεσμος & το QR ζουν πλέον **μόνο** στην καρτέλα «QR & σύνδεσμοι» (έφυγε η διπλή εμφάνιση + η προεπισκόπηση).']},
    {'v': '12.439', 'b': '720', 'date': '08/07/2026', 'time': '10:45', 'title': 'Διόρθωση: το Piato δεν άνοιγε (κρας στη λίστα σημείων)',
     'items': ['Διορθώθηκε σφάλμα στο διαχειριστικό Piato που εμφάνιζε «Object of type Undefined is not JSON serializable» και δεν άνοιγε η οθόνη όταν δεν είχε επιλεγεί σημείο (η αρχική λίστα). Το QR script δεν προστάτευε την περίπτωση «κανένα επιλεγμένο σημείο».']},
    {'v': '12.438', 'b': '719', 'date': '08/07/2026', 'time': '02:10', 'title': 'Piato — Management Hub: επισκόπηση/στατιστικά, QR generator, εκτυπώσιμο PDF μενού, ρυθμίσεις',
     'items': ['Το διαχειριστικό Piato (`/dashboard/piato`) έγινε **hub** με καρτέλες: **Επισκόπηση · Μενού · QR & σύνδεσμοι · Εκτύπωση · Ρυθμίσεις**.',
               '**Επισκόπηση** — στατιστικά με μια ματιά: κατηγορίες, πιάτα, **% μεταφρασμένα**, μη διαθέσιμα (86\'d), **προβολές** μενού, κατάσταση δημοσίευσης + γρήγορες ενέργειες.',
               '**QR generator** — QR σε χρώμα CONDIAN, κατέβασμα **PNG/SVG**, **εκτύπωση κάρτας** & αντιγραφή συνδέσμου (client-side, χωρίς εξάρτηση server).',
               '**Εκτυπώσιμο PDF μενού** — branded (λογότυπο + κατηγορίες/πιάτα/τιμές), **επιλογή γλώσσας** (EL/EN/DE/IT/FR), έτοιμο για εκτύπωση.',
               '**Ρυθμίσεις σημείου** μαζεμένες σε δική τους καρτέλα (όνομα, ξενοδοχείο, τύπος, ωράριο, παλέτα, tagline, review links, ερωτηματολόγιο) + ξεχωριστή «επικίνδυνη ζώνη» διαγραφής.']},
    {'v': '12.437', 'b': '718', 'date': '07/07/2026', 'time': '23:40', 'title': 'AI — Advanced Console (κονσόλα διακυβέρνησης · cockpit) + ενιαίο κουμπί AI + βοηθός «Sophia»',
    ...
    {'v': '12.435', 'b': '716', 'date': '07/07/2026', 'time': '20:47', 'title': 'Piato — αναβάθμιση διαχειριστικού μενού: σύμπτυξη/σειρά, tabs γλωσσών, ένδειξη μεταφράσεων + DE/IT/FR',
     'items': ['**Σύμπτυξη/άνοιγμα κατηγοριών** (και «όλων») + **μετρητής πιάτων** ανά κατηγορία → εύκολη διαχείριση μεγάλων μενού με μια ματιά.',
               ...
               '**Πολυγλωσσία:** προστέθηκαν **Γερμανικά / Ιταλικά / Γαλλικά** (5 γλώσσες συνολικά). Καθαρή εισαγωγή με **καρτέλες ανά γλώσσα** (EL·EN·DE·IT·FR) + τελίτσα «συμπληρωμένο/κενό».',
               '**Ένδειξη μεταφράσεων ανά πιάτο** στη λίστα (EL EN DE IT FR — πράσινο = έτοιμο, γκρι = λείπει) → βλέπεις αμέσως τι μένει να μεταφραστεί.',
               'Σαφέστερο κουμπί διαθεσιμότητας («Σήμανε εξαντλημένο» / «Ξανά διαθέσιμο») + μικρογραφία φωτό στη λίστα πιάτων.']},
    ...
    {'v': '12.432', 'b': '713', 'date': '07/07/2026', 'time': '16:30', 'title': 'Piato — πολύγλωσσο UI (EL/EN) + Δίστηλο ανά γραμμή + φωτεινό hub',
     'items': ['Τα **σταθερά κείμενα του μενού** (Προσθήκη, Απόκρυψη αλλεργιογόνων, Επαναφορά, Η παραγγελία μου, Σύνολο, Πίσω κ.λπ.) αλλάζουν πλέον γλώσσα μαζί με το μενού: **Ελληνικά / Αγγλικά**. Πριν ήταν πάντα Ελληνικά.',
               'Ο τρόπος **«Δίστηλο»** διαβάζεται πλέον **ανά γραμμή**: δίπλα σε κάθε κατηγορία εμφανίζεται η ΕΠΟΜΕΝΗ κατηγορία (π.χ. Ορεκτικά | Σαλάτες), όχι η συνέχεια της ίδιας σε δεύτερη στήλη.',
               '**Οθόνη υποδοχής (hub) — φωτεινή έκδοση:** καθαρό λευκό φόντο, λιτές λευκές κάρτες, εικονίδια σε χρυσό (μαχαιροπίρουνο = φαγητό, ποτήρι = ποτό), τίτλος ξενοδοχείου ενσωματωμένος. Έφυγε η μπάρα προεπισκόπησης.',
               'Διαθέσιμες γλώσσες σε **EL / EN** (Φ1 — όσες έχουν περιεχόμενο)· εύκολα επεκτάσιμο.']},
    {'v': '12.431', 'b': '712', 'date': '07/07/2026', 'time': '15:56', 'title': 'Piato — φωτεινή οθόνη υποδοχής (hub) + καθαρό header μενού + γλώσσες κάτω από το ωράριο',
     'items': ['**Οθόνη υποδοχής (hub) — νέο φωτεινό look:** λευκό φόντο, λευκές κάρτες με τη χρωματική πινελιά κάθε σημείου (ανά παλέτα), απαλές σκιές — καθαρό και φιλικό για τον πελάτη. Έφυγε η γκρι μπάρα από την κορυφή (η ένδειξη «προεπισκόπηση» πήγε διακριτικά κάτω, μόνο για την ομάδα).',
               'Κάθε κάρτα δείχνει **εικονίδια ανάλογα με το τι σερβίρει**: 🍽 φαγητό, 🍸 ποτό, ή και τα δύο (π.χ. εστιατόριο που σερβίρει και ποτό, pool bar που σερβίρει και φαγητό).',
               '**Μενού πελάτη:** έφυγε η ξεχωριστή μπάρα στην κορυφή — το «← Πίσω» επιπλέει διακριτικά και η κορυφή έχει πλέον ενιαίο χρώμα με το υπόλοιπο μενού.',
               'Οι **γλώσσες** μετακινήθηκαν κάτω από το ωράριο, ως κωδικοί (EL · EN · DE · FR · IT · RU · BG) με ενεργή την τρέχουσα.']},
    {'v': '12.430', 'b': '711', 'date': '07/07/2026', 'time': '19:30', 'title': 'Piato — «κατάλογος παραγγελίας» (order pad) στο tablet + φινίρισμα μενού πελάτη',
     'items': ['**Νέο — Κατάλογος παραγγελίας (order pad):** κάθε πιάτο έχει κουμπί «＋ Προσθήκη». Ο πελάτης χτίζει την επιλογή του σε ένα πλαίσιο που ανοίγει από δεξιά («Η παραγγελία μου») με εύκολα κουμπάκια **＋ / −** ανά είδος, **✕ αφαίρεση** και ζωντανό **σύνολο**. Ιδανικό για tablet: ο πελάτης διαλέγει και δείχνει την οθόνη στον σερβιτόρο. (Καθαρά τοπικό — καμία αποστολή/χρέωση· θεμέλιο για μελλοντική ηλεκτρονική παραγγελιοληψία.)',
               'Το **header** παίρνει πλέον αυτόματα το χρώμα του υπόλοιπου μενού (ανά παλέτα) — ενιαία εικόνα.',
               'Το **υπομενού κατηγοριών** μένει «κολλημένο» (sticky) στην κορυφή καθώς κάνεις scroll — εύκολη πλοήγηση σε μεγάλους καταλόγους.',
               'Footer: ίδια γραμματοσειρά σε όλες τις γραμμές και **ESTIA** στα λατινικά (Powered by Piato · ESTIA © 2026 · CONDIAN Hotels).',
               'Όλα εφαρμόζονται αυτόματα σε ΟΛΑ τα μενού κάθε σημείου & ξενοδοχείου (κοινό πρότυπο).']},
    {'v': '12.429', 'b': '710', 'date': '07/07/2026', 'time': '14:10', 'title': 'Piato — μενού πελάτη full-width + κομψό header + footer 3 γραμμές',
     'items': ['Το μενού του πελάτη γίνεται **full-width** — γεμίζει όλο το πλάτος της οθόνης (τέλος τα κενά αριστερά/δεξιά).',
               'Καθαρότερο **header**: τα κουμπιά «επιστροφή» και «γλώσσα» επιπλέουν διάφανα πάνω στο εικαστικό του hero — έφυγε η ξεχωριστή σκούρα μπάρα με τη σκληρή γραμμή, το πάνω μέρος δείχνει πλέον ενιαίο και premium.',
               'Footer σε 3 γραμμές: **Powered by Piato** · **Εστία © 2026** · **CONDIAN Hotels**.']},
    {'v': '12.428', 'b': '709', 'date': '07/07/2026', 'time': '13:52', 'title': 'Piato — καθαρό μενού πελάτη: +Λίστα/Linen, 3 κουμπιά αξιολόγησης, footer Εστία/CONDIAN, θωράκιση φόντου',
     'items': ['3 τρόποι παρουσίασης πλέον: Πλέγμα (κάρτες) · Δίστηλο (magazine) · **Λίστα (κλασική)** — κομψή μονόστηλη λίστα με τελίτσες, ιδανική για fine-dining. Επιλέγεται ανά σημείο από την κονσόλα.',
               '5 χρωματικές παλέτες πλέον: προστέθηκε η φωτεινή **«Linen & Sage»** (ζεστό λινό + φασκομηλιά) — δεύτερη φωτεινή επιλογή δίπλα στο Boho, ιδανική για pool/beach/café.',
               'Καθάρισμα «demonstration»: αφαιρέθηκε ό,τι έμενε από τη λειτουργία επίδειξης (νεκρός κώδικας εναλλάκτη) και η ετικέτα «DRAFT» από το μενού. Θωρακίστηκε το φόντο ώστε να είναι συνεκτικό σε ΚΑΘΕ παλέτα — οριστικό τέλος στο «γκρι».',
               'Νέα 3 κουμπιά αξιολόγησης ανά σημείο (εμφανίζονται μόνο όσα ορίσεις): **Google review · TripAdvisor · Ερωτηματολόγιο**. Το «Ερωτηματολόγιο» κουμπώνει στα ερωτηματολόγια της Εστίας (module Surveys) — οι απαντήσεις μαζεύονται μέσα στο σύστημα (NPS, αποτελέσματα, εξαγωγή), όχι σε εξωτερική φόρμα.',
               'Footer μενού: «Powered by Εστία» + «CONDIAN Hotels · © 2026».',
               'Διαχειριστικό: κουμπί προεπισκόπησης που ανοίγει το πραγματικό μενού με την επιλεγμένη εμφάνιση (δουλεύει και πριν τη δημοσίευση) + 2 πεδία link (Google/TripAdvisor) και επιλογή ερωτηματολογίου ανά σημείο.']},
    {'v': '12.427', 'b': '708', 'date': '07/07/2026', 'time': '10:00', 'title': 'Piato — έφυγε η μπάρα προεπισκόπησης + ζέσταμα φωτεινής παλέτας (τέλος στο «γκρι»)',
     'items': ['Αφαιρέθηκε η μπάρα προεπισκόπησης (εναλλάκτης modes/παλέτας) από το μενού του πελάτη — η ομάδα αποφάσισε, δεν χρειάζεται πια. Το μενού δείχνει σταθερά το θέμα/τρόπο που έχει οριστεί ανά σημείο.',
               'Το «γκρι φόντο» εντοπίστηκε (browser-verified): ήταν η φωτεινή παλέτα «Boho», που ήταν πολύ αχνή/χαμηλού κορεσμού και διαβαζόταν σαν γκρι. Ζεστάθηκε σε αληθινό ηλιόλουστο κρεμ/άμμο — τώρα το pool bar δείχνει ζεστό και καλοκαιρινό.']},
    {'v': '12.426', 'b': '707', 'date': '07/07/2026', 'time': '09:00', 'title': 'Piato — βαθιά αναβάθμιση εικαστικού πελάτη + ομαδοποίηση Φαγητό/Ποτό + καθάρισμα κονσόλας',
     'items': ['ΔΙΟΡΘΩΣΗ «γκρι»: τα εξαντλημένα (86′d) πιάτα εμφανίζονταν ως ξεθωριασμένες γκρι κάρτες (λόγω opacity σε όλη την κάρτα). Τώρα η κάρτα μένει συμπαγής, θαμπώνει μόνο το κείμενο + μένει καθαρή η ένδειξη «εξαντλήθηκε». Ίδια θωράκιση και στις κάρτες του hub (πάντα συμπαγές φόντο).',
               'Ομαδοποίηση μενού σε ΦΑΓΗΤΟ / ΠΟΤΟ: κάθε κατηγορία ορίζεται από την κονσόλα ως φαγητό ή ποτό· ο πελάτης βλέπει δύο κύριες καρτέλες (όταν υπάρχουν και τα δύο). Οι κατηγορίες ποτών (κρασιά, cocktails, μπύρες, καφέδες…) μπήκαν αυτόματα στο «Ποτό».',
               'Νέα στον πελάτη: κουμπί «★ Αξιολογήστε μας» (ρυθμιζόμενο link ανά σημείο), κουμπί «← επιστροφή» στην οθόνη υποδοχής του ξενοδοχείου, και καθαρός επιλογέας γλώσσας πάνω-δεξιά (αντί για σειρά συνδέσμων).',
               'Καθάρισμα guest look: πιο κομψές κάρτες, καλύτερη αναγνωσιμότητα σε όλες τις παλέτες (σκούρες + φωτεινό Boho), σωστό «σπάσιμο» μεγάλων ονομάτων αλλεργιογόνων, responsive Δίστηλο.',
               'Διαχειριστικό: αφαιρέθηκαν τα κρυφά links προεπισκόπησης ομάδας (μένουν μόνο τα δημόσια QR), έφυγε ο διπλός τίτλος header, και η κονσόλα έγινε full-width.']},
...
def _inject_dark(resp):
    try:
        # Guest σελίδες Piato (/piato/…) έχουν ΔΙΚΟ τους πλήρες εικαστικό (light hub, palette μενού)
        # → ΔΕΝ δέχονται το admin dark theme (αλλιώς το injected estia-theme.css πατάει τα χρώματά τους).
        _guest = request.path.startswith('/piato/')
        if (resp.content_type or '').startswith('text/html') and not _guest:
...
ROADMAP = [
    {'area': 'Συντήρηση', 'items': [
        {'t': 'Εκκαθάριση Ρυθμίσεων (υπόλοιπα)', 's': 'planned'},
        {'t': 'Ενοποίηση Δομής — αφαίρεση «Σημεία» (Δρόμος A)', 's': 'planned'},
        {'t': 'Ρυθμίσεις — Συχνότητα (ενσωμάτωση)', 's': 'planned'},
        {'t': 'Σημεία hub Φ2 — συγχώνευση + μεταφορά', 's': 'planned'},
        {'t': 'Φόρμα «Σήμερα» — Template C (desktop)', 's': 'planned'},
        {'t': 'Χρωματικοί κωδικοί μετρήσεων/σημείων', 's': 'planned'},
        {'t': 'Setup σημείων στα άλλα 4 ξενοδοχεία', 's': 'planned'},
        {'t': 'Χειροκίνητος έλεγχος SERGIOS μετά reshape', 's': 'planned'},
        {'t': 'Κονσόλα Φ2 — extra μετρήσεις πισίνας + Excel', 's': 'planned'},
        {'t': 'Ημερήσιο checklist συντήρησης (flushing)', 's': 'planned'},
        {'t': 'Ζώνες = hub Σημείων Δειγματοληψίας (υπόλοιπα)', 's': 'planned'},
        {'t': 'Δρόμος προς 110% — Ρυθμίσεις (D/E)', 's': 'planned'},
        {'t': 'Προτεινόμενα: ειδοποιήσεις·QR·sparklines·Legionella PDF', 's': 'planned'},
        {'t': 'Επιβεβαίωση flagged migrations (live)', 's': 'planned'},
        {'t': 'Καθάρισμα dead Board CSS', 's': 'planned'},
        {'t': 'Μητρώο Εξοπλισμού (assets, κόστος, QR) — δένει με Βλάβες', 's': 'planned'},
        {'t': 'Προληπτική συντήρηση / προγραμματισμένες εργασίες', 's': 'planned'},
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Import Excel αρχείου — guard + audit κλειδώματος παρελθόντος', 's': 'planned'},
        {'t': 'Auto-split ΕΡΓ+ΕΩ & στα άλλα μονοπάτια εισαγωγής', 's': 'planned'},
        ...
        {'t': 'Αξιολόγηση: τράπεζα ερωτήσεων + σύνθεση ερωτηματολογίου με drag&drop (βάρος ανά φύλλο)', 's': 'planned'},
    ...
    {'area': 'Διακυβέρνηση', 'items': [
        ...
        {'t': 'Εικόνες εκτός DB (object storage) όταν μεγαλώσει ο όγκος — η DB να μη φουσκώνει', 's': 'planned'},
    ]},
    {'area': 'Πλατφόρμα', 'items': [
        ...
        {'t': 'Ξεκαθάρισμα «προσωπικό vs χρήστες login» (αν το προσωπικό πρέπει να είναι users ή merge με master)', 's': 'planned'},
        {'t': 'Μεταφράσεις EN/UK', 's': 'planned'},
        {'t': 'Σύνδεση μισθοδοσίας με ΕΡΓΑΝΗ/Epsilon (μέσω προγράμματος)', 's': 'planned'},
    ...
    {'area': 'Data Hub', 'items': [
        {'t': 'Φ4: Control-plane UI + review screen (P-091)', 's': 'planned'},
        {'t': 'Χαρτογράφηση: ⚠ ανοιχτά πεδία', 's': 'planned'},
        {'t': '**Διαχωρισμός πηγών + λύση διπλού** (οθόνη Epsilon / Management / Μίξη)', 's': 'planned'},
        {'t': '289 «coverage-gap» παλιές γραμμές (δώρα/2026 μήνας≠datahub) — πιθανό μικρό υπόλοιπο διπλού 2026', 's': 'planned'},
        {'t': '**True incremental agent** (watermark read) — τώρα `--live` = full pull κάθε φορά', 's': 'planned'},
        {'t': '**Αδυνάτισμα bronze + αρχιτεκτονική αποθήκευσης** (ΜΕΛΛΟΝ, όχι τώρα)', 's': 'planned'},
        {'t': 'XRISI=0 «καρτέλα/ειδικά» → **ΛΥΘΗΚΕ** (απάντηση λογιστηρίου 10/07)', 's': 'done'},
    ]},
    {'area': 'Οικονομικά', 'items': [
        {'t': 'Pack 02 — queries έσοδα/πληρότητα', 's': 'planned'},
        {'t': 'Φ0 μοντέλο δεδομένων (mapping)', 's': 'planned'},
        {'t': 'Pylon = Φ4 pluggable extractor', 's': 'planned'},
        {'t': 'read-only `estia_reader` στο `Hotel`', 's': 'planned'},
        {'t': 'Ενημέρωση spec με πραγματικά ονόματα', 's': 'planned'},
        {'t': 'Inventory Pylon `Hotel` — **ΕΓΙΝΕ 11/07** (map_pylon.ps1 από desktop)', 's': 'done'},
    ]},
    {'area': 'PMS', 'items': [
        {'t': 'Μοντέλο δεικτών (occupancy/ADR/RevPAR)', 's': 'planned'},
...
@app.route('/dashboard/ai/persona', methods=['POST'])
def ai_persona_save():
    u = current_user()
    if u is None or u.role != 'masteradmin':
        return redirect(url_for('login'))
    val = (request.form.get('persona') or '').strip()
    row = Setting.query.get('ai_persona')
    if row is None:
        db.session.add(Setting(key='ai_persona', value=val))
    else:
        row.value = val
    db.session.commit(); log_activity('ai_persona', 'default' if not val else 'custom')
    return redirect(url_for('ai_admin') + '?saved=1')
