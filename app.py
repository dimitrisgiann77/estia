...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: ανάθεση (✓), τμήματα ανά ξεν. (✓), υπεύθυνος (✓), φωτό (✓), ΕΝΑ write-path +ιστορικό (✓), import seed-only + διαφωνίες Epsilon + banner (✓), ροή νέου=συνδυασμός (✓), λωρίδα Διεύθυνσης curated (✓)· επόμενα: ΜΕΛΕΤΗ δικαιωμάτων/login υπευθύνου, κάρτα-μητρώο μέσα στο οργανόγραμμα, διπλό ιστορικό', 's': 'progress'},
    ]},
