...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: ανάθεση/τμήματα/υπεύθυνος/φωτό/write-path/διαφωνίες Epsilon/λωρίδα Διεύθυνσης (✓), διαχείριση τμημάτων edit/delete/reorder (✓)· επόμενα: επιλεγμένα=μοναδικό φίλτρο (#2/#7), αναδιάταξη οθόνης (#5), ΣΥΖΗΤΗΣΗ HQ/τυπικό οργανόγραμμα/παρελθόν (#3/#6/#8), δικαιώματα υπευθύνου, διπλό ιστορικό', 's': 'progress'},
    ]},
