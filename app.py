...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: …, διαχείριση τμημάτων (✓), επιλεγμένα=μοναδικό φίλτρο #2/#7 (✓)· επόμενα: αναδιάταξη οθόνης (#5), ΣΥΖΗΤΗΣΗ HQ/τυπικό οργανόγραμμα/παρελθόν (#3/#6/#8), δικαιώματα υπευθύνου, διπλό ιστορικό', 's': 'progress'},
    ]},
