...
CHANGELOG = [
    {'v': '12.382', 'b': '663', 'date': '02/07/2026', 'time': '16:20', 'title': 'Πρόγραμμα — τέλος στο full-page reload μετά από καταχώρηση (P-058 Φ1)',
     'items': ['Μετά από κάθε αποθήκευση/επικόλληση στο εβδομαδιαίο & μηνιαίο πρόγραμμα, ανανεώνεται πλέον ΜΟΝΟ ο πίνακας — όχι όλη η σελίδα. Πιο γρήγορο, κρατά τη θέση scroll, χωρίς «αναπήδηση».',
               'Ίδιο layout/λειτουργία — τα σύνολα & οι κανόνες υπολογίζονται πάντα από τον server (μία πηγή αλήθειας). Νέος κοινός helper (static/estia_swap.js) για μελλοντική χρήση και σε άλλες οθόνες.']},
