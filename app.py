...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: ανάθεση τμήμα+ξενοδοχείο (✓), διαχείριση τμημάτων ανά ξενοδοχείο (✓)· επόμενα: ορισμός supervisors, διπλό ιστορικό (έτη/περίοδοι)', 's': 'progress'},
    ]},
