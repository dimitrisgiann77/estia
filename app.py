...
CHANGELOG = [
    {'v': '12.433', 'b': '714', 'date': '07/07/2026', 'time': '19:34', 'title': 'Piato — θωράκιση κατά του «auto dark mode» (τέλος στο «γκρι φόντο»)',
     'items': ['Λύθηκε οριστικά το «γκρι/σκούρο φόντο» που εμφανιζόταν σε ορισμένους browsers: ήταν το **Auto Dark Mode** του browser (π.χ. Edge) που σκούραινε μόνο του τις φωτεινές σελίδες. Προστέθηκε δήλωση `color-scheme` (hub=light, μενού=ανά παλέτα) ώστε ο browser να ΜΗΝ αλλοιώνει τα χρώματα — κάθε οθόνη δείχνει ακριβώς όπως σχεδιάστηκε.']},
