...
CHANGELOG = [
    {'v': '12.135', 'b': '415', 'date': '20/06/2026', 'time': '10:00', 'title': 'Πρόγραμμα — γυάλισμα τσιπ/μάσκας + draggable παράθυρο + χρώματα κωδικών',
     'items': ['Τσιπ βάρδιας: κωδικός+ώρες πάνω, ώρες βάρδιας + σύντομος κωδικός ξενοδοχείου ΚΑΤΩ, στοιχισμένα στο κέντρο.',
