...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: ανάθεση τμήμα+ξενοδοχείο (✓), τμήματα ανά ξενοδοχείο (✓), υπεύθυνος ανά τμήμα (✓)· επόμενα: λωρίδα Διεύθυνσης, helper assign_user_org + πίνακας διαφωνιών Epsilon, διπλό ιστορικό', 's': 'progress'},
    ]},
