...
CHANGELOG = [
    {'v': '12.453', 'b': '734', 'date': '10/07/2026', 'time': '13:30', 'title': 'Business Μισθοδοσία — οθόνη επιθεώρησης σύνδεσης Epsilon (το πρώτο σημείο ελέγχου)',
     'items': ['Νέα οθόνη **«Business Μισθοδοσία (Epsilon)»** μέσα στη Μισθοδοσία: read-only επιθεώρηση **τι φέρνει ολόκληρη** η σύνδεση από την Epsilon, πριν μπει στα κυκλώματα της Εστίας — χωρίς κατέβασμα Excel. Πάνω-πάνω «κατάσταση σύνδεσης» (γραμμές, εργαζόμενοι, τελ. συγχρονισμός, ✓ λειτουργεί).',
