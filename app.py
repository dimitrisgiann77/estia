...
ROADMAP = [
    ...
    {'area': 'Προσωπικό / HR', 'items': [
        ...
        {'t': 'Οργανόγραμμα — κονσόλα HR: ανάθεση τμήμα+ξενοδοχείο (✓), τμήματα ανά ξενοδοχείο (✓), υπεύθυνος ανά τμήμα (✓, φαίνεται & στο Πρόγραμμα), φωτό προφίλ (✓)· επόμενα: ΜΕΛΕΤΗ δικαιωμάτων/login υπευθύνου (υποβολή προγράμματος τμήματος), λωρίδα Διεύθυνσης, helper assign_user_org + πίνακας διαφωνιών Epsilon + popup μέχρι admin, διπλό ιστορικό', 's': 'progress'},
    ]},
