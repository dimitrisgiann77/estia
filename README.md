# Εστία — CONDIAN HOTELS

**Εστία (Estia):** η κεντρική πλατφόρμα προσωπικού & συνεργατών των ξενοδοχείων CONDIAN
(πρώην "Water & Pool Log"). Βασικές ενότητες:
...
## v11 — Πλατφόρμα Συντήρησης (γενική μηχανή τομέων)

- **Τομείς (templates):** ο admin ορίζει τι παρακολουθούμε — παράμετροι, μονάδες, όρια, ενέργειες, συχνότητα. Έτοιμα: Στάθμες/Δεξαμενές, Ενέργεια/Μετρητές (+ Πισίνες & ΖΝΧ ως υπάρχοντα modules).
- **Καταγραφή (`/areas`):** η φόρμα χτίζεται αυτόματα από το template του τομέα. Νέος τομέας = νέο template, χωρίς κώδικα.
- **Πίνακας (`/areas/dashboard`)**, **διαχείριση τομέων (`/dashboard/areas`)**, **editor templates (`/dashboard/templates`)**.
- Όρια→ενέργειες, alerts, ρόλοι/αναθέσεις ισχύουν και στους νέους τομείς.
- Επιλογή ημερομηνίας στο PDF πισινών.
