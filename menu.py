...
MENU_CATALOG = [
    ...
    ('acct_audit',  'Έλεγχος λογαριασμών',    'ti-user-search',      '/dashboard/payroll/account_audit', False),
    ...
    ('sched_imphub', 'Ταυτοποίηση εισαγωγών',  'ti-user-search',      '/dashboard/schedule/import_hub', False),
...
DEFAULT_LAYOUT = [
    ...
    {'ws': 'admin', 'title': 'Προσωπικό (HR)', 'items': ['hr_hub', 'people', 'org', 'pay_mitroo', 'sched_status', 'sched_imphub', 'sched_identify', 'sched_imported', 'dups', 'acct_audit', 'sched_staff']},
...
DEFAULT_META = {
    ...
    'dups':           {'ws': ['admin'], 'roles': []},
    'acct_audit':     {'ws': ['admin'], 'roles': []},
    'hr_hub':         {'ws': ['admin'], 'roles': []},
    'sched_imphub':   {'ws': ['admin'], 'roles': []},
